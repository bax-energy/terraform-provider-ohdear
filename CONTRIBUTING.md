...
Please review our [Code of Conduct](https://github.com/bax-energy/terraform-provider-ohdear/.github/blob/main/CODE_OF_CONDUCT.md). It is in effect at all times. We expect it to be honored by everyone who contributes to this project. Acting like an asshole will not be tolerated.

## :bulb: Asking Questions

See our [Support Guide](https://github.com/bax-energy/terraform-provider-ohdear/.github/blob/main/SUPPORT.md). In short, GitHub issues are not the appropriate place to debug your specific project, but should be reserved for filing bugs and feature requests.
...
Review our [Security Policy](https://github.com/bax-energy/terraform-provider-ohdear/.github/blob/main/SECURITY.md). **Do not** file a public issue for security vulnerabilities.
...
- **Review the documentation and [Support Guide](https://github.com/bax-energy/terraform-provider-ohdear/.github/blob/main/SUPPORT.md)** before opening a new issue.
...
- **Update the CHANGELOG** for all enhancements and bug fixes. Include the corresponding issue number if one exists, and your GitHub username. (example: "- Fixed crash in profile view. #123 @bax-energy/terraform-provider-ohdear")
...
Written by [@bax-energy/terraform-provider-ohdear](https://github.com/bax-energy/terraform-provider-ohdear). 
